...
export default function AddInstruction(props) {
  ...
  return (
    <div className="add__option">
      <svg className="add__whole" data-testid="add-instruction-button" onClick={submitInstruction} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 125" version="1.1" x="0px" y="0px">
